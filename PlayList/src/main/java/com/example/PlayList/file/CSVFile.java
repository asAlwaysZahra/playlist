...
public class CSVFile {
    ...
    static public ArrayList<Music> readCSV() {
        ...
        try (CSVReader reader = new CSVReader(new FileReader(fileName))) {
            List<com.example.PlayList.file.Music> beans = new CsvToBeanBuilder(new FileReader(fileName))
                    .withType(com.example.PlayList.file.Music.class)
                    .build()
                    .parse();
